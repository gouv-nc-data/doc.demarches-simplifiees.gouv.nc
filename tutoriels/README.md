...
Cette rubrique contient les tutoriels permettant d'apprendre à utiliser **https://demarches-simplifiees.gouv.nc** en tant qu’administrateur, instructeur et usager.

Les tutoriels décrivent de manière précise les manipulations nécessaires à l'utilisation de **demarches-simplifiees.gouv.nc** selon les profils suivants :
